...
public class FileStorageService {
    ...
    public FileMetadata store(MultipartFile file) {
        ...
        try {
            return repository.save(new FileMetadata(
                    originalName,
                    storedName,
                    contentType,
                    file.getSize(),
    ...
    public List<FileMetadata> list(String search) {
        if (search == null || search.isBlank()) {
            return repository.findAllByOrderByUploadedAtDesc();
        }
        return repository.findByOriginalFileNameContainingIgnoreCaseOrderByUploadedAtDesc(search.trim());
    }
