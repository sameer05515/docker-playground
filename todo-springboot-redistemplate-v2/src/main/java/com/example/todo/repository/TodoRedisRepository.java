...
public class TodoRedisRepository {
    ...
    public Todo save(Todo todo) {
        ...
        redisTemplate.opsForSet().add(TODO_IDS_KEY, todo.getId().toString());
    ...
    public List<Todo> findAll() {
        ...
        Set<Object> ids = redisTemplate.opsForSet().members(TODO_IDS_KEY);
    ...
    public void deleteById(Long id) {
        ...
        redisTemplate.opsForSet().remove(TODO_IDS_KEY, id.toString());
    }

    public void refreshTtl(Long id, long seconds) {
        redisTemplate.expire(key(id),
                java.time.Duration.ofSeconds(seconds));
    }

    public Long getKeyCount() {
        return redisTemplate.opsForSet().size(TODO_IDS_KEY);
    }

    private Todo read(String key) {
