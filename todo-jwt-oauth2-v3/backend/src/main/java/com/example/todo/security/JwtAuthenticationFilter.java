...
public class JwtAuthenticationFilter extends OncePerRequestFilter {
    ...
    public JwtAuthenticationFilter(JwtService j, UserDetailsService u, TokenRevocationService r) {
        jwtService = j;
    ...
    protected void doFilterInternal(HttpServletRequest req, HttpServletResponse res, FilterChain chain) throws ServletException, IOException {
        ...
        try {
            ...
            if (revocationService.isRevoked(token) || !jwtService.valid(token) || SecurityContextHolder.getContext().getAuthentication() != null) {
                chain.doFilter(req, res);
                return;
            }
